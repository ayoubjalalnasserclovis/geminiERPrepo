-- Ajoute le numero d'appartement sur properties (utilisable pour livraisons artisans/fournisseurs)
ALTER TABLE properties
  ADD COLUMN IF NOT EXISTS apartment_number TEXT;

COMMENT ON COLUMN properties.apartment_number IS
  'N° appartement / lot dans l''immeuble (ex: A12, Lot 3, Appt 24...)';

-- Force la regeneration de la vue properties_enriched pour inclure la nouvelle colonne
