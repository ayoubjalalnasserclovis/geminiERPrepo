-- ============================================================================
-- Restauration des gates documents pour livraison → mise_en_location
-- (perdus par mégarde dans la migration 20260527006000)
-- + ajout du contrat internet comme document OBLIGATOIRE pour la mise en location
-- ============================================================================
...
BEGIN
  ...
  -- Gates phase Mise en location (restaurés + ajout contrat_internet)
  IF v_project.current_phase = 'livraison' AND p_new_phase = 'mise_en_location' THEN
    ...
    END IF;
    -- NOUVEAU : contrat internet obligatoire pour la mise en location
